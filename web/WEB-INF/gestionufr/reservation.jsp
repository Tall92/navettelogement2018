                    ...
                    <div class="card">
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-bordered table-striped table-hover">
                                ...
                                <c:forEach items="${reservations}" var="e">
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="gestionnaire?action=valider&iduser=${e.utilisateur.idUser}&idcham=${e.chambre.idCh}&entree=<fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${e.entree}" />&sortie=<fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${e.sortie}" />">Valider</a>
                                        </td>
                                        <td>
                                            <c:if test="${e.etat eq 0}">
                                            <a class="btn btn-primary" href="gestionnaire?action=annuler_log&iduser=${e.utilisateur.idUser}&idcham=${e.chambre.idCh}&entree=<fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${e.entree}" />&sortie=<fmt:formatDate type="date" pattern="yyyy-MM-dd" value="${e.sortie}" />">Annuler</a>
                                            </c:if>
                                            </td>
